...
class OrderItemFactoryTest {
    ...
    private Product validProduct = ProductFactory.createProduct(1,"MissDog", "Nibbles","placeholder.jpg", 4f, 249.99f, 19.00f, 23, 1.34f, "SaveMor", "Adult", "Dry", "Dog", "Chicken", categories);
